 ...
 * @version $Revision: 1.1 $ / $Date: 2009/06/09 11:11:08 $ / ($Author: ObertM $)
 */
public class CopyOfCmdInterpreter extends Thread
{
   ...
   * @param timeOutMinutes Timeout für eine Socket-Verbindung 
   */
  public CopyOfCmdInterpreter( int port, int timeOutMinutes, CmdMenu root )
  {
   ...
   */
  public CopyOfCmdInterpreter( int port, int timeOutMinutes, boolean showHidden )
  {
    this( port, timeOutMinutes );
