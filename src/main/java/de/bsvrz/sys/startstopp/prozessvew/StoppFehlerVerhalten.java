...
/**
 * Klasse zum Realisieren der Einstellungen für das Stoppfehlerverhalten eines
 * Prozessen
 ...
 */
  ...
  public class StoppFehlerVerhalten
  {
     ...
     * Option
     */
    private E_STOPP_FEHLER_VERHALTEN m_option;
     ...
     */
    public E_STOPP_FEHLER_VERHALTEN getOption()
    {
      return m_option;
    }
     ...
     */
    public void setOption( E_STOPP_FEHLER_VERHALTEN option )
    {
      m_option = option;
    }
