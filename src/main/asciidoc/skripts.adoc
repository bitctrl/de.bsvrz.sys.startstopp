...
der StartStopp-Konfiguration mit übergeben. Für die Komponenten des Kernsystems wird die Übergabe des Parameters
...
Anmerkung: Bei der Auswertung der Zirkularität von Start- oder Stopp werden nur lokale
